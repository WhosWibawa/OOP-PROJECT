...
public class Camera {
    private ArrayList<Cams> cameralist = new ArrayList<>();
    ...
    public void orderInvoice(int memberID, int camID, int noTelp) {
        Member member = this.memberList.get(memberID - 1);
        Cams cams = this.cameralist.get(camID - 1);
        ...
        System.out.println(
                "SIlahkan lakukan Down Payment 50 persen dari total sewa untuk keep invoice permanen, payment bisa ditransfer ke rekening 123456 a/n wibaw");
        member.greets();
    }
